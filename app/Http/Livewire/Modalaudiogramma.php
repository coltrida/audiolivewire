...
class Modalaudiogramma extends Component
{
    ...
    public function scegliAudiometria($id)
    {
        $this->idAudiometria = $id;
    }
    ...
    public function render(AudiogrammaService $audiogrammaService)
    {
        ...
        if(!$this->idAudiometria){
            ...
            $audiometria = $audiogrammaService->caricaSpecificaAudiometria($this->idAudiometria);

            $this->attualeSinistro[0] = $audiometria->_125s;
            $this->attualeSinistro[1] = $audiometria->_250s;
            $this->attualeSinistro[2] = $audiometria->_500s;
            $this->attualeSinistro[3] = $audiometria->_1000s;
            $this->attualeSinistro[4] = $audiometria->_1500s;
            $this->attualeSinistro[5] = $audiometria->_2000s;
            $this->attualeSinistro[6] = $audiometria->_3000s;
            $this->attualeSinistro[7] = $audiometria->_4000s;
            $this->attualeSinistro[8] = $audiometria->_6000s;
            $this->attualeSinistro[9] = $audiometria->_8000s;

            $this->attualeDestro[0] = $audiometria->_125d;
            $this->attualeDestro[1] = $audiometria->_250d;
            $this->attualeDestro[2] = $audiometria->_500d;
            $this->attualeDestro[3] = $audiometria->_1000d;
            $this->attualeDestro[4] = $audiometria->_1500d;
            $this->attualeDestro[5] = $audiometria->_2000d;
            $this->attualeDestro[6] = $audiometria->_3000d;
            $this->attualeDestro[7] = $audiometria->_4000d;
            $this->attualeDestro[8] = $audiometria->_6000d;
            $this->attualeDestro[9] = $audiometria->_8000d;
        }
