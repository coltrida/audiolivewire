    ...
    <form class="my-4" action="#" wire:submit.prevent = {{$idClient ? "modifica" : "aggiungi"}}>
        ...
        <div class="row">
            <div class="mb-3 col-3">
                ...
                <input type="text" wire:model.defer="client.nome" class="form-control" placeholder="nome">
            </div>
            <div class="mb-3 col-3">
                <label for="cognome" class="form-label">Cognome @error('cognome')  <span class="text-red-500 text-xs"> - {{ $message }}</span> @enderror</label>
                <input type="text" wire:model.defer="client.cognome" class="form-control" placeholder="cognome">
            </div>
            <div class="mb-3 col-3">
                <label for="telefono" class="form-label">Telefono</label>
                <input type="text" wire:model.defer="client.telefono" class="form-control" placeholder="telefono">
            </div>
            <div class="mb-3 col-3">
                <label for="codfisc" class="form-label">Codice Fiscale</label>
                <input type="text" wire:model.defer="client.codfisc" class="form-control" placeholder="codice fiscale">
            </div>
        </div>
        ...
        <div class="row">
            <div class="mb-3 col-3">
                ...
                <input type="text" wire:model.defer="client.indirizzo" class="form-control" placeholder="indirizzo">
            </div>
            <div class="mb-3 col-3">
                <label for="citta" class="form-label">Città @error('citta') <span class="text-red-500 text-xs"> - {{ $message }}</span> @enderror</label>
                <input type="text" wire:model.defer="client.citta" class="form-control" placeholder="citta">
            </div>
            <div class="mb-3 col-2">
                <label for="cap" class="form-label">CAP @error('cap') <span class="text-red-500 text-xs"> - {{ $message }}</span> @enderror</label>
                <input type="text" wire:model.defer="client.cap" class="form-control" placeholder="cap">
            </div>
            <div class="mb-3 col-2">
                ...
                <input type="text" wire:model.defer="client.provincia" class="form-control" placeholder="provincia">
            </div>
            <div class="mb-3 col-2">
                ...
                <select class="form-select" wire:model.defer="client.filiale_id" aria-label="Default select example">
        ...
        <div class="row">
            <div class="mb-3 col-3">
                ...
                <select class="form-select" wire:model.defer="client.recapito_id" aria-label="Default select example" >
                    <option selected></option>
            ...
            <div class="mb-3 col-3">
                ...
                <input type="text" wire:model.defer="client.mail" class="form-control" placeholder="mail">
            </div>
            <div class="mb-3 col-2">
                <label for="tipo" class="form-label">Tipo @error('tipo') <span class="text-red-500 text-xs"> - {{ $message }}</span> @enderror</label>
                <select class="form-select" wire:model.defer="client.tipo" aria-label="Default select example">
                    <option selected></option>
            ...
            <div class="mb-3 col-2">
                <label for="fonte" class="form-label">Canale Mkt @error('client.marketing_id') <span class="text-red-500 text-xs"> - {{ $message }}</span> @enderror</label>
                <select class="form-select" wire:model.defer="client.marketing_id" aria-label="Default select example">
                    <option selected></option>
                    @foreach($canali as $canale)
                        <option @if(isset($client->nome)) {{$canale->id == $client->marketing_id ? 'selected' : ''}} @endif value="{{$canale->id}}">{{$canale->name}}</option>
                    @endforeach
                </select>
            </div>
            <div class="mb-3 col-2">
                <label for="fonte" class="form-label">Data Nascita</label>
                <input type="date" wire:model.defer="client.datanascita" class="form-control">
            </div>
        </div>
